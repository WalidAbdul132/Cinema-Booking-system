		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container">
				...
				<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item  active"><a class="nav-link" href="ticket.php">Tickets</a></li>
					</ul>
				</div>
			</div>
		</nav>
...
-->
    ...
    <section class="container ticket_cover">
  <div class="row">
      
      <?php
                $sql_test= "SELECT * FROM Bookings";
      ...
      <section class="card-cont">
        ...
        <input type="submit" name="submit" value="Cancel">
           ...
           <?php
                    ...
                    echo "there are no tickets here";
                }     
